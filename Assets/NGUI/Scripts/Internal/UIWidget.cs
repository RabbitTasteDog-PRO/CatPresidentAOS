...
public class UIWidget : UIRect
{
	...
	// private void SetAnchorTargetPanel()
    // {
    //     if( leftAnchor.isTargetPanel == -1 )
    //     {
    //         if( leftAnchor.target.GetComponent<UIPanel>() == null )
    //         {
    //             leftAnchor.isTargetPanel = 0;
    //             rightAnchor.isTargetPanel = 0;
    //             bottomAnchor.isTargetPanel = 0;
    //             topAnchor.isTargetPanel = 0;
    //         }
    //         else
    //         {
    //             leftAnchor.isTargetPanel = 1;
    //             rightAnchor.isTargetPanel = 1;
    //             bottomAnchor.isTargetPanel = 1;
    //             topAnchor.isTargetPanel = 1;
    //         }
    //     }
    // }

    // private int[] GetSafeAreaAnchor()
    // {
    ...
    //     SetAnchorTargetPanel();

    //     // 타겟이 패널일 경우에만 설정
    //     if( leftAnchor.isTargetPanel == 1 )
    //     {
    //         if( leftAnchor.relative == rightAnchor.relative )
    //         {
    //             int addX = HOW.IHProjectManager.Instance.safeArea.addX;

    //             if( leftAnchor.relative == 0 )
    //             {
    //                 returnValue[ 0 ] += addX;
    //                 returnValue[ 1 ] += addX;
    //             }
    //             else if( leftAnchor.relative == 1 )
    //             {
    //                 returnValue[ 0 ] -= addX;
    //                 returnValue[ 1 ] -= addX;
    //             }
    ...
    //         if( bottomAnchor.relative == topAnchor.relative )
    //         {
    //             int addY = HOW.IHProjectManager.Instance.safeArea.addY;

    //             if( bottomAnchor.relative == 0 )
    //             {
    //                 returnValue[ 2 ] += addY;
    //                 returnValue[ 3 ] += addY;
    //             }
	...
	protected override void OnAnchor ()
	{
			...
			leftAnchor.target == topAnchor.target)
		{
			...
			// if (sides != null)
			// {
            //     int[] addSafeArea = GetSafeAreaAnchor();

			// 	lt = NGUIMath.Lerp(sides[0].x, sides[2].x, leftAnchor.relative) + leftAnchor.absolute + addSafeArea[ 0 ];
			// 	rt = NGUIMath.Lerp(sides[0].x, sides[2].x, rightAnchor.relative) + rightAnchor.absolute + addSafeArea[ 1 ];
			// 	bt = NGUIMath.Lerp(sides[3].y, sides[1].y, bottomAnchor.relative) + bottomAnchor.absolute + addSafeArea[ 2 ];
			// 	tt = NGUIMath.Lerp(sides[3].y, sides[1].y, topAnchor.relative) + topAnchor.absolute + addSafeArea[ 3 ];
			// 	mIsInFront = true;
			// }
			// else
			// {
